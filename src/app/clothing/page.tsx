  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="pt-32 pb-12 px-6 max-w-[1440px] mx-auto text-center">
        ...
        <h1 className="text-5xl md:text-7xl font-black tracking-tighter italic mb-8">OBSESSED CLOTHING.</h1>
        <p className="text-secondary max-w-2xl mx-auto mb-12">
          Engineered for enthusiasts. Premium hoodies, t-shirts, and apparel designed to reflect your obsession with the drive.
        </p>
      </div>
         ...
         <div className="max-w-[1440px] mx-auto grid" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '3rem' }}>
          ...
          <div>
            ...
            <ul className="space-y-4 text-secondary text-sm font-medium">
              ...
              <li><a href="/clothing" className="text-accent transition-colors block">Clothing</a></li>
